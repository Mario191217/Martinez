...
namespace Martinez.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdUsuario,Usuario,Password,IdRol,IdEmpleado")] Usuarios usuarios)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdUsuario,Usuario,Password,IdRol,IdEmpleado")] Usuarios usuarios)
        {
            if (ModelState.IsValid)
            {
